...
class TacticalAdvisor:
    def __init__(self, db_path="data/op_stats.json"):
        ...
        # ⚡ Bolt: Pre-compute lowercase keys for O(1) case-insensitive lookups
    ...
    def get_operator_data(self, name):
        ...
        # ⚡ Bolt: Use O(1) hash map lookup instead of O(N) loop
        name_lower = name.lower()
        if name_lower in getattr(self, '_name_map', {}):
