...
# Flask-SocketIO requires a callable for regex validation
socketio = SocketIO(app, cors_allowed_origins=lambda origin: origin is not None and bool(cors_regex.match(origin)))
